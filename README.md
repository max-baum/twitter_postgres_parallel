...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | [![tests_normalized_sequential](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_normalized.yml/badge.svg)](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_normalized.yml) | [![tests_normalized_parallel](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_normalized_parallel.yml/badge.svg)](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_normalized_parallel.yml) |
| normalized (batched) | [![tests_normalizedbatch_sequential](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_normalized_batch.yml/badge.svg)](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_normalized_batch.yml) |  [![tests_normalizedbatch_parallel](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_normalized_batch_parallel.yml/badge.svg)](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_normalized_batch_parallel.yml) |
| denormalized | [![tests_denormalized_sequential](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_denormalized.yml/badge.svg)](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_denormalized.yml) | [![tests_denormalized_parallel](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_denormalized_parallel.yml/badge.svg)](https://github.com/max-baum/twitter_postgres_parallel/actions/workflows/tests_denormalized_parallel.yml) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |              1m15.799s             |              10.964s             | 
| `pg_normalized_batch`  |             2m22.817s              |                 17.280s          | 
| `pg_denormalized`      |                  22.480s         |              3.699s             | 
